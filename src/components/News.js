...
export class News extends Component {
  ...
  async updatefunc(p) {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=${this.props.apikey}&page=${p}&pageSize=${this.props.pageSize}`
    this.setState({
      loading: true
    })
